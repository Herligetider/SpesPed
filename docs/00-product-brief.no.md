...
Arbeidsversjon 0.1 · 7. september 2026. Alle tidligere foreslåtte funksjoner er beholdt. Dette dokumentet beskriver ønsket produkt; ingen funksjon er implementert ennå.
...
- Ukesoppdateringer bare til foresatte i første versjon. Elevrettet oppdatering beholdes som senere funksjon.
...
6. Ved ukeslutt klargjøres et foresattutkast, og ved relevante frister klargjøres vurderings- og rapportutkast.
...
| Ukesoppdatering | Valgfri ukerytme per elev | Godkjente, relevante observasjoner og neste ukes plan | Valgt lærer/spesialpedagog | Kun berettigede foresatte i første versjon |
...
- Klargjøring og kontroll av ukesoppdatering krever vesentlig mindre tid enn dagens arbeidsmåte.
